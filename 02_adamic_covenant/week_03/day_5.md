...
- **The Fall Relived** -- David's sin with Bathsheba replays the pattern of Genesis 3: seeing, desiring, taking, hiding. The fall is not an ancient event. It is a present reality in every human heart.
- ***Bara* -- The Need for New Creation** -- David does not ask for moral improvement. He asks for creation -- the same verb Genesis 1:1 uses for the making of the universe. The fall broke something only the Creator can fix.
- **Confession as the Anti-Fig-Leaf** -- Where Adam hid and blamed, David stops hiding and confesses. The broken heart God will not despise is the opposite of the fig-leaf religion God replaced in Genesis 3:21. Honesty before God is the only posture that receives grace.
...
[Week 2](../../01_creation_covenant/week_02/overview.md) | [Overview](overview.md) [1](day_1.md) [2](day_2.md) [3](day_3.md) [4](day_4.md) **5** [Discussion](discussion.md) | [Week 4](../week_04/overview.md)
