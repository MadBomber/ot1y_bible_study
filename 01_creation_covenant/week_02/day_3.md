...
- **"Not Good" and the Making of Community** -- Aloneness is the only deficiency in creation. The solution is not more of God but another human being. God designs humanity for both vertical relationship (with him) and horizontal relationship (with one another). The church will be built on the same architecture.
- ***Ezer Kenegdo*** -- The woman is not an assistant but a corresponding strength -- the same word used for God himself coming to Israel's aid. Genesis 2 establishes the dignity, power, and equality of the woman from the first moment of her existence.
- **Marriage as Gospel** -- The first marriage is already pointing to the last. Adam's sleep and opened side prefigure Christ's death and the birth of the church. The "one flesh" union anticipates the union of Christ and his bride. The story of Genesis 2 cannot be fully read without Ephesians 5.
...
[Week 1](../week_01/overview.md) | [Overview](overview.md) [1](day_1.md) [2](day_2.md) **3** [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 3](../../02_adamic_covenant/week_03/overview.md)
