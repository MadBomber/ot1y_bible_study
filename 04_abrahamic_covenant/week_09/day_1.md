...
- **Election by Grace, Not Merit** -- God's call to Abram is unexplained by any prior faithfulness. Joshua 24:2 reveals that his family served other gods. The call does not reward virtue; it creates it. This is the pattern of every divine calling that follows -- Moses the murderer, David the shepherd boy, Paul the persecutor -- and it reaches its fullest expression in the gospel: "While we were still sinners, Christ died for us" (Romans 5:8).

- **Promise Before Performance** -- The five "I will" declarations are given before Abram has believed, obeyed, or been circumcised. The promise creates the faith, not the other way around. God does not say, "Because you have been faithful, I will bless you." He says, "I will bless you" -- and then watches what the blessing produces. This is the grammar of grace.

- **Worship in the Space Between Promise and Possession** -- Abram builds altars at Shechem and Bethel while the Canaanites still occupy the land. He worships in a territory he does not own, honoring a promise he cannot yet see. This is the posture of all biblical faith -- living and worshipping in the gap between what God has said and what God has done.
...
[Week 8](../../03_noahic_covenant/week_08/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 10](../week_10/overview.md)
