...
- **The mobility of God's glory** -- The *kavod* that filled Solomon's temple appears in Babylon, among exiles, by an irrigation canal. God is not a local deity confined to a shrine. His glory travels. His presence is not dependent on human structures. This truth prepares the ground for the incarnation, where the glory of God will take up residence not in a building but in a body.

- **The failure of human shepherds** -- Ezekiel 34 is an indictment not of foreign enemies but of Israel's own leaders. The shepherds feed themselves and neglect the flock. The weak are unstrengthened, the sick unhealed, the lost unsought. Human leadership, however well-positioned, inevitably fails when it serves itself rather than those it is charged to protect.

- **The divine-Davidic shepherd** -- God declares that he himself will shepherd the people -- and then promises to do it through "my servant David." The oracle creates a requirement that seems impossible: a shepherd who is both God and David's heir. The tension is deliberate. It can only be resolved by a person who is both -- and the New Testament identifies that person without hesitation.
...
[Week 42](../week_42/overview.md) | [Overview](overview.md) [1](day_1.md) [2](day_2.md) [3](day_3.md) **4** [5](day_5.md) [Discussion](discussion.md) | [Week 44](../week_44/overview.md)
