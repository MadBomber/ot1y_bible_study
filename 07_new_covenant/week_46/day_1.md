...
- **The concealed identity** -- Esther hides her Jewishness at Mordecai's instruction. The concealment creates dramatic tension that will drive the entire narrative. It also raises an uncomfortable question: is there a time when wisdom requires hiddenness rather than public confession? The text does not resolve the tension. It lets it build.
...
[Week 45](../week_45/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 47](../week_47/overview.md)
