...
week: 48
day: 1
title: "Build the House -- and the Latter Glory Shall Be Greater Than the Former"
reading: "Haggai 1:1-2:23"
parallel_passages: Matthew 12:6, Matthew 21:12-13, John 1:14, John 2:19-21, Hebrews 3:3-6
...
- **Misplaced priorities and divine futility** -- Haggai exposes the connection between spiritual neglect and material insufficiency. The people sow much and harvest little because they have reversed the order of allegiance. Where you build reveals whom you serve, and the God who will not be second uses even economic frustration as a summons back to himself.
- **The latter glory surpassing the former** -- By every visible metric, the second temple is inferior to Solomon's. Yet God promises a glory that exceeds the original. The promise cannot be fulfilled by architecture. It requires a presence -- the incarnate Son, whose entry into the temple is the fulfillment Haggai foresaw.
- **The signet ring restored** -- God's declaration that Zerubbabel will be "like a signet ring" reverses the curse on the Davidic line (Jeremiah 22:24) and reestablishes the royal authority that exile had shattered. The promise passes through Zerubbabel to Christ, the ultimate heir of David's throne.
...
[Week 47](../week_47/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 49](../week_49/overview.md)
