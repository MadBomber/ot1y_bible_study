...
- **The God who overrules objections** -- Moses presents five reasons he cannot go. God answers every one -- not by inflating Moses but by revealing himself. The deliverer's qualifications are irrelevant. The sender's identity is everything. This pattern defines the nature of biblical calling: it is not a recruitment of the competent but a commission from the sovereign.

- **Signs as theological previews** -- The serpent, the leprous hand, and the water turned to blood are not arbitrary displays. They are compressed anticipations of the plagues and, beyond the plagues, of the redemptive work of Christ. Each sign demonstrates God's authority over a specific domain: chaos, disease, and the powers of the oppressor.

- **Weakness as the instrument of divine power** -- Moses' admission that he is "heavy of mouth and heavy of tongue" does not disqualify him. It positions him to demonstrate that the power behind the mission is not human eloquence but divine authority. The same principle governs the cross: God's power is made perfect in weakness (2 Corinthians 12:9).
...
[Week 16](../../04_abrahamic_covenant/week_16/overview.md) | [Overview](overview.md) [1](day_1.md) [2](day_2.md) [3](day_3.md) **4** [5](day_5.md) [Discussion](discussion.md) | [Week 18](../week_18/overview.md)
