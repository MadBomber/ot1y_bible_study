...
- **The danger of self-appointed mediation** -- Korah's rebellion is not a struggle for justice but a rejection of God's ordained order. The argument that "all the congregation are holy" contains a truth but deploys it to dismantle the structure God has established. Holiness does not eliminate the need for mediation; it heightens it.
- **Intercession in the gap** -- Aaron running between the living and the dead with a censer of incense is one of the most concentrated images of priestly mediation in Scripture. The mediator does not stand safely outside the crisis. He enters it, bearing the instruments of atonement, and his presence stops the destruction.
- **The severity and the mercy** -- The earth opens, fire falls, a plague spreads -- and yet God provides the means to stop every judgment he sends. The severity reveals the stakes of approaching God on human terms. The mercy reveals the sufficiency of approaching God through his appointed mediator.
...
[Week 25](../week_25/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 27](../week_27/overview.md)
