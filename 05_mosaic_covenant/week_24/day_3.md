...
- **Holiness as public ethics** -- Leviticus 19 defines holiness not as private devotion or ritual precision but as the way a community treats its most vulnerable members: the poor, the deaf, the blind, the immigrant, the day laborer waiting for his wages. Holiness is fairness, honesty, generosity, and impartiality made habitual.
- **The love command in its original soil** -- "You shall love your neighbor as yourself" originates in Leviticus 19:18, embedded in a legal code that specifies what love looks like in practice: no vengeance, no grudges, honest weights, fair wages, justice without partiality, and compassion extended to the foreigner. Jesus identifies this command as the second pillar on which "all the Law and the Prophets" depend.
- **Divine character as ethical standard** -- The refrain "I am the LORD" punctuates every section of Leviticus 19-20, grounding every command in the identity of God. Holiness is not an abstract ideal. It is the character of a specific God, extended as a pattern for the life of his people.
