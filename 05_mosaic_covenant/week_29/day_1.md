...
- **The tension of "much land remains"** -- God's gifts are real and his victories are decisive, but the life of faith involves inhabiting what has been given, not merely celebrating the conquest. The promise is both a gift and a calling. Israel must settle the land that God has already declared theirs.
- **Caleb's undimmed faith** -- Forty-five years of wilderness wandering did not erode Caleb's conviction. His request for the hill country of the Anakim is faith tested by time and found stronger, not weaker. The decades refined what they could not destroy.
- **Land as covenant document** -- The boundary descriptions are not administrative tedium. They are the deed of inheritance, written in the language of rivers and mountains, proving that the God of sweeping promises works in surveyor-level detail.
...
[Week 28](../week_28/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 30](../week_30/overview.md)
