...
week: 8
day: 4
title: "From Shem to Terah -- The Genealogy Narrows Toward Abraham"
reading: "Genesis 11:10-26"
parallel_passages: Luke 3:34-36, Matthew 1:1-2, Hebrews 11:8-10, Genesis 12:1-3
...
- **The Narrowing Lens** -- The genealogy moves from the broad family of Shem to a single household in Ur. This narrowing is the method of redemption: God does not solve the problem of seventy scattered nations with a universal program but with one man, one call, one promise. The particular is the path to the universal.

- **Declining Vitality** -- The steadily decreasing lifespans from Shem (600 years) to Terah (205 years) are a quiet testimony to the trajectory of the post-flood world. The flood preserved life but did not restore it. Something more is needed -- a salvation that addresses not merely the symptoms of the fall but its root.

- **The Genealogy as Runway** -- This passage connects the universal history of Genesis 1-11 to the particular history of Genesis 12-50. It is the bridge between the problem and the solution, the runway from which the Abrahamic covenant will take flight. Every name is a step toward the call.
...
[Week 7](../week_07/overview.md) | [Overview](overview.md) [1](day_1.md) [2](day_2.md) [3](day_3.md) **4** [5](day_5.md) [Discussion](discussion.md) | [Week 9](../../04_abrahamic_covenant/week_09/overview.md)
