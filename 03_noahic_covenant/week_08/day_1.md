...
- **Theological Geography** -- Genesis 10 is not a census. It is a declaration that every nation on earth descends from Noah's family and exists under the umbrella of God's covenant with all flesh. The rainbow hangs over Canaanites and Cushites and Egyptians alike. No people falls outside the scope of God's post-flood promise.

- **Nimrod and the Rise of Empire** -- The appearance of Nimrod as the first *gibbor* and empire-builder signals that the consolidation of human power is already underway. His kingdom begins at Babel -- the very city whose tower will provoke God's judgment in chapter 11. Empire, in Genesis, is not morally neutral. It is the organized expression of the same pride that reached for the forbidden fruit.

- **Unity in Diversity** -- The fourfold classification of clan, language, land, and nation acknowledges the genuine diversity of the human family while insisting on its common origin. The nations are different. They are also related. This tension -- real diversity within fundamental unity -- will structure the entire biblical narrative of redemption.
...
[Week 7](../week_07/overview.md) | [Overview](overview.md) **1** [2](day_2.md) [3](day_3.md) [4](day_4.md) [5](day_5.md) [Discussion](discussion.md) | [Week 9](../../04_abrahamic_covenant/week_09/overview.md)
