...
translation: ESV
image: week-50-memory-verse.png
connections:
  - "Day 1 — Isaiah 24 describes cosmic judgment — the earth staggering, broken, defiled by its inhabitants' transgression. The devastation is the backdrop against which Isaiah 25:8 blazes: the same God who judges the earth swallows the death that has consumed every generation since Adam."
  - "Day 2 — Isaiah 25-27 places the feast on the mountain where death is swallowed and tears are wiped away. The vision is universal: 'for all peoples.' The God who judges in chapter 24 hosts a banquet in chapter 25, and the guest list has no national boundary."
  - "Day 3 — Joel 3 gathers the nations into the Valley of Decision for judgment. The LORD roars from Zion. Yet the same prophetic tradition that announces judgment promises that death itself will be consumed — the ultimate enemy defeated not by human effort but by divine devouring."
  - "Day 4 — Malachi's furnace burns the arrogant to stubble, while the sun of righteousness rises 'with healing in its wings' (Malachi 4:2). Zephaniah's God sings over the rescued (Zephaniah 3:17). The tears wiped in Isaiah 25:8 are replaced by the song of a God who rejoices over the redeemed."
  - "Day 5 — Psalms 96 and 98 invite rivers to clap, hills to sing, and the sea to roar — all because the Judge is coming. Creation does not dread the day when death is swallowed; creation celebrates it, because the curse that subjected it to futility is finally undone."
prev_week_path: /07_new_covenant/week_49/memory_verse
next_week_path: /08_consummation/week_51/memory_verse
---
